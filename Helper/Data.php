...
/**
 * PrecisoBidSmartAdvertising data helper
 */
namespace Preciso\PrecisoBidSmartAdvertising\Helper;
...
{
    /**
     * Path to store config where count of precisobidsmartadvertising posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'precisobidsmartadvertising/view/items_per_page';
     ...
     * @var string
     */
    const MEDIA_PATH    = 'PrecisoBidSmartAdvertising';
    ...
    /**
     * Remove PrecisoBidSmartAdvertising item image by image filename
     *
    ...
    public function resize(
        \Preciso\PrecisoBidSmartAdvertising\Model\PrecisoBidSmartAdvertising $item,
        $width,
        $height = null
    ) {
        if (!$item->getImage()) {
    ...
    /**
     * Return the base media directory for PrecisoBidSmartAdvertising Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for PrecisoBidSmartAdvertising Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getPrecisoBidSmartAdvertisingPerPage()
    {
        return abs((int)$this->_scopeConfig
            ->getValue(
