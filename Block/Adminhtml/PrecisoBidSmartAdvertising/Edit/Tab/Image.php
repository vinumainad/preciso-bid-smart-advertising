    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form = $this->_formFactory->create(['data' => ['html_id_prefix' => 'precisobidsmartadvertising_image_']]);
        ...
        $this->_eventManager
        ->dispatch('adminhtml_precisobidsmartadvertising_edit_tab_image_prepare_form', ['form' => $form]);
    ...
    {
        return ['image' => Preciso\PrecisoBidSmartAdvertising\Block\Adminhtml\Form\Element\Image::class];
    }
}
